...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="ImageSharingWithCloudService" generation="1" functional="0" release="0" Id="e3bbbd72-ae5a-4ce7-aeb0-ab674c06d270" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="ImageSharingWithCloudServiceGroup" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="ImageSharingWebRole" generation="1" functional="0" release="0" software="D:\Course\CS526\ImageSharingWithCloudService\ImageSharingWithCloudService\csx\Release\roles\ImageSharingWebRole" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaIISHost.exe " memIndex="-1" hostingEnvironment="frontendadmin" hostingEnvironmentVersion="2">
            <componentports>
        ...
        <groupHascomponents>
          <role name="ImageSharingWorkerRole" generation="1" functional="0" release="0" software="D:\Course\CS526\ImageSharingWithCloudService\ImageSharingWithCloudService\csx\Release\roles\ImageSharingWorkerRole" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaWorkerHost.exe " memIndex="-1" hostingEnvironment="consoleroleadmin" hostingEnvironmentVersion="2">
            <settings>
              <aCS name="APPINSIGHTS_INSTRUMENTATIONKEY" defaultValue="" />
  ...
  <implements>
    <implementation Id="14146def-381a-4380-9092-97b59d451051" ref="Microsoft.RedDog.Contract\ServiceContract\ImageSharingWithCloudServiceContract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="c701640d-4e84-4e6f-a7de-a7318ac50154" ref="Microsoft.RedDog.Contract\Interface\ImageSharingWebRole:Endpoint1@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/ImageSharingWithCloudService/ImageSharingWithCloudServiceGroup/ImageSharingWebRole:Endpoint1" />
          </inPort>
        </interfaceReference>

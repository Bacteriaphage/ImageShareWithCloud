...
namespace ImageSharingWebRole.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public ActionResult Delete()
        {
            ...
            //foreach (var u in ActiveUsers().ToArray())
        ...
        public ActionResult Delete(List<SelectItemView> model)
        {
            ...
            foreach (var umod in model)
            {
                ...
                //ApplicationUser user = ApplicationDBContext.Users.FirstOrDefault(x => x.Id == umod.Id);
                ApplicationUser user = ApplicationDBContext.Users.Find(umod.Id);
